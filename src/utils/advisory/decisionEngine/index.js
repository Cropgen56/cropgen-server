/**
 * Decision Engine - Modular advisory recommendations
 * Produces structured hints for LLM to format into farmer-friendly messages.
 */
...
/**
 * Run all decision engines and return hints for LLM.
 * @param {Object} evidence - Structured evidence from evidenceBuilder
 * @param {boolean} isHarvestStage - If true, disable spray and fertigation
 * @returns {Object} decisionHints
 */
...
export { getSprayDecision, getFertigationDecision, getPGRDecision, getIrrigationDecision, getMonitoringDecision };
